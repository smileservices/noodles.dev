...
from study_resource.fake_internal import new_study_resource, new_study_resource_review
...
class InternalStudyResourceTestCase(TestCase):
    ...
    def test_review_vote_validation_author(self):
        ...
        self.assertRaisesMessage(ValidationError, InternalReview.ErrorMessages.USER_VOTE_OWN_REVIEW,
                                 review.vote_up,
                                 review_author
                                 )
