    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.IntegerField(choices=[(0, 'Public Domain'), (1, 'Permissive License'), (2, 'Copyleft'), (3, 'Non-Commercial'), (4, 'Proprietary'), (5, 'Trade Secret')], db_index=True, default=0)),
                ('url', models.TextField(max_length=1024)),
                ('owner', models.CharField(db_index=True, max_length=128)),
                ('pros', models.TextField()),
                ('cons', models.TextField()),
                ('limitations', models.TextField()),
                ('image_file', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='technologies')),
